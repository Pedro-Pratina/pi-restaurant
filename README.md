...
Projeto Integrador I (PI I) - Introdução ao Desenvolvimento Web  
Curso: Ciência da Computação  
Instituição: UNASP  
Semestre: 1º Semestre - 2026

## Descrição do Projeto
Recriação de um site completo para um restaurante escolhido pelo grupo.  
Objetivo: Aplicar conceitos básicos de HTML, CSS e JavaScript.

Restaurante escolhido: "Nu Sushi Delivery"
